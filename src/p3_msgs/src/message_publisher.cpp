#include <ros/ros.h>
#include <p3_msgs/example.h>
#include <math.h>

int main(int argc, char** argv){
	ros::init(argc, argv, "message_publisher"); // name of this node 
    ros::NodeHandle n; // two lines to create a publisher object that can talk to ROS
    ros::Publisher my_publisher_object = n.advertise<p3_msgs::example>("example_topic", 1);

	p3_msgs::example my_new_message;
